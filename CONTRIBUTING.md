...
- Please see the [git-flow cheatsheet](http://danielkummer.github.com/git-flow-cheatsheet/) for a guide on how pull requests should be structured for things like new features and bug-fixes.
    - Branches for features should be made from the *development* branch.
    - Branches for bug-fixes should be made from the *master* branch.
    - Please ensure that all tests pass before submitting a pull request.

**Before contributing to Icicle, you will need to agree to the [Contributor License Agreement (CLA)](http://en.wikipedia.org/wiki/Contributor_License_Agreement) below.**

This agreement is available as a [PDF form](https://icicle.io/files/cla.pdf) or the text below can be copied to a new document. The agreement should be completed and electronically signed, then emailed to [hello@icicle.io](mailto:hello@icicle.io) before any submitted pull request can be merged.

```

Contributor License Agreement

Thank you for your interest in contributing to Icicle (icicle.io) ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by email to [hello@icicle.io]. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
6.1 This Agreement will be governed by and construed in accordance with the laws of Minnesota and the United States of America, excluding its conflicts of law provisions. Under certain circumstances, the governing law in this section might be superseded by the United Nations Convention on Contracts for the International Sale of Goods ("UN Convention") and the parties intend to avoid the application of the UN Convention to this Agreement and, thus, exclude the application of the UN Convention in its entirety to this Agreement.
...
Address: 
Email: 
Signature (name enclosed by slashes (e.g., /Your Name/)): 

```

The license above was adopted from the [Harmony Contributor License Agreement](http://www.harmonyagreements.org/agreements.html).
